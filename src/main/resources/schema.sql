...
INSERT INTO vacancy (id, title, description, category_id, salary, exp_from, exp_to, is_active, employer_id, created_date, update_time)
VALUES
    (1, 'Junior Java Developer', 'Работа в команде разработки',
