...
public class WorkExperienceInfoMapper {
    public static WorkExperienceInfoResponseDto toDto(WorkExperienceInfo workExperienceInfo) {
        ...
        dto.setResumeId(workExperienceInfo.getResumeId());
    ...
    private static WorkExperienceInfo fronDto(WorkExperienceInfoRequestDto requestDto) {
        if (requestDto == null) return null;
        WorkExperienceInfo workExperienceInfo = new WorkExperienceInfo();
        workExperienceInfo.setResumeId(requestDto.getResumeId());
